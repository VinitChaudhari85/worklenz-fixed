    ...
    >
      <Dropdown menu={{ items }} trigger={['contextMenu']}>
        ...
        <Flex vertical gap={8} onClick={e => handleCardClick(e, task.id || '')}>
          {task.cover_url && (
            <div className="board-task-cover" style={{ width: 'calc(100% + 24px)', height: '140px', overflow: 'hidden', borderRadius: '6px 6px 0 0', margin: '-12px -12px 4px -12px', backgroundColor: 'rgba(128,128,128,0.1)' }}>
              <img
                src={task.cover_url}
                alt="Cover"
                loading="lazy"
